...
const config: ProductFullConfig = {
  ...
  pricing: {
    ...
    addons: [
      ...
      {
        id: "gesrest_eventos",
        slug: "eventos-y-entradas",
        name: "Eventos y Entradas",
        description: "Organiza, promueve y controla cada evento con",
        category: "other",
        price: { amountMonthly: 50, amountAnnual: 500, currency: "PEN", currencySymbol: "S/" },
        compatiblePlanIds: ["gesrest_base"],
        features: ["Eventos Personalizados en Maps", "Control de Promotores con enlaces", "Entradas por Codigo QR", "Control de asistencia en puerta"],
        isAvailable: true,
      },
    ],
    faq: {
